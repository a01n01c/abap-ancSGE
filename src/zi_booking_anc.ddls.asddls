@AbapCatalog.sqlViewName: 'ZV_BOOKING_ANC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Vista de la tabla reservas'
...
define root view ZI_BOOKING_ANC
  as select from ztbooking_anc as Booking
  association [0..1] to I_Country  as _Country  on Booking.country = _Country.Country
  association [0..1] to I_Currency as _Currency on Booking.currencycode = _Currency.Currency
